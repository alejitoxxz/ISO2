...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleBusiness(final BusinessException ex) {
        return new ResponseEntity<>(ApiErrorResponse.businessError(ex.getMessage()), HttpStatus.CONFLICT);
    }

    @ExceptionHandler(NotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleNotFound(final NotFoundException ex) {
        return new ResponseEntity<>(ApiErrorResponse.businessError(ex.getMessage()), HttpStatus.NOT_FOUND);
    }
